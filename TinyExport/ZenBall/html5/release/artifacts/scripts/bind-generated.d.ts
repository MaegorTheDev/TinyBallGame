...
declare namespace game{
    ...
    class InputHelper extends ut.Component {
        constructor();
        InputType: InputType;
        FirstTouchData: ut.Math.Vector2;
        IsClickDown: boolean;
        static readonly cid: number;
        static readonly _view: any;
        static readonly _isSharedComp: boolean;
    ...
    class ObstacleSpawnerHelper extends ut.Component {
        ...
        XScaleValues: ut.Math.Vector2;
        YScaleValues: ut.Math.Vector2;
        BorderOffset: number;
    ...
    class ShotPeg extends ut.Component {
        constructor();
        InitialSprite: ut.Entity;
        CurrentSprite: ut.Entity;
        UsedSprite: ut.Entity;
        static readonly cid: number;
        static readonly _view: any;
        static readonly _isSharedComp: boolean;
        static _size: number;
...
declare namespace ut{
    ...
    interface EntityGroups{
        ...
        game: {
            ...
            Coin: EntityGroupData;
            Hole: EntityGroupData;
            Obstacle: EntityGroupData;
            ShotPeg: EntityGroupData;
            BallGroup: EntityGroupData;
            Bootstraper: EntityGroupData;
            GameOver: EntityGroupData;
            GameplayEntityGroup: EntityGroupData;
            GameStart: EntityGroupData;
            TutorialEntityGroup: EntityGroupData;
        }
    }
}
